    ...
    def plot(self):
        ...
        while not terminate: 
            ...
            if print_mode == 1: 
                ...
                fig.savefig("figure/QLearning/%sx%s/[Train] Success and Fail Count.png"%(str(self.map_size),str(self.map_size)))
            elif print_mode == 2: 
                ...
                axes.set(ylabel="Count")
                fig.savefig("figure/QLearning/%sx%s/[Test] Success and Fail Count.png"%(str(self.map_size),str(self.map_size)))
            elif print_mode == 3:
                ...
                fig.savefig("figure/QLearning/%sx%s/[Train] Average reward vs episode.png"%(str(self.map_size),str(self.map_size)))
            elif print_mode == 4:
                ...
                fig.savefig("figure/QLearning/%sx%s/[Test] Average reward vs episode.png"%(str(self.map_size),str(self.map_size)))
            elif print_mode == 5:
                ...
                axes.set_ylim(ymax=250,ymin=0)
                fig.savefig("figure/QLearning/%sx%s/[Train] Number of step per episode.png"%(str(self.map_size),str(self.map_size)))
            elif print_mode == 6:
                ...
                fig.savefig("figure/QLearning/%sx%s/[Test] Number of step per episode.png"%(str(self.map_size),str(self.map_size)))
            elif print_mode == 7:
